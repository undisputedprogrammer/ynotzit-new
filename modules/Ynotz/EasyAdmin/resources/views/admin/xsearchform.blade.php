<x-easyadmin::partials.adminpanel>
        <div x-data="{
                ...
                triggerFetch() {
                    ...
                    $dispatch('linkaction', {link: this.indexUrl, params: allParams, fresh: true, fragment: 'main-panel', target: 'renderedpanel'});
                },
                doSearch(param) {
                    ajaxLoading = true;
            ...
            {{-- @if (isset($advSearchFields) && count($advSearchFields) > 0) --}}
                <x-easyadmin::utils.advsearchinline :advSearchFields="$advSearchFields"/>
            {{-- @endif --}}
