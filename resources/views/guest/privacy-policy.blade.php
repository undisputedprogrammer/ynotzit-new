...
<div class=" w-[94%] mx-auto my-5">
    <h2 class=" font-inter_semibold text-lg md:text-2xl xl:text-4xl  mt-3 xl:mt-9 ">This Privacy Policy applies to the Ynotzitsolutions.com</h2>
    ...
    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">Demographic information.</span> We may collect demographic information about you, events you like, events you intend to participate in, tickets you buy, or any other information provided by your during the use of our website. We might collect this as a part of a survey also.

    </p>

    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">Other information.</span>
    ...
    <p class=" font-inter_regular text-sm md:text-base xl:text-lg "><span class=" font-inter_medium">We collect information from you passively.</span>
    ...
    <p class=" font-inter_regular text-sm md:text-base xl:text-lg "><span class=" font-inter_medium">We get information about you from third parties</span>
    ...
    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We use information to respond to your requests or questions:</span> We might use your information to confirm your registration for an event or contest.</p>

    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We use information to improve our products and services:</span> We might use your information to customize your experience with us. This could include displaying content based upon your preferences.</p>

    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We use information to look at site trends and customer interests:</span> We may use your information to make our website and products better. We may combine information we get from you with information about you we get from third parties.</p>

    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We use information for security purposes:</span> We may use information to protect our company, our customers, or our websites.
    ...
    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We use information for marketing purposes:</span>
         We might send you information about special promotions or offers. We might also tell you about new features or products. These might be our own offers or products, or third-party offers or products we think you might find interesting. Or, for example, if you buy tickets from us we'll enroll you in our newsletter. </p>

    <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We use information to send you transactional communications:</span>
        ...
        <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We will share information with the event organizers:</span>
        ...
        <p class=" font-inter_regular text-sm md:text-base xl:text-lg mt-2"><span class=" font-inter_semibold">We will share information with our business partners:</span>
        ...
        <p class=" font-inter_regular mt-1 text-sm md:text-base xl:text-lg"><span class=" font-inter_medium">Email:</span> pr@ynotzitsolutions.com</p>
        <p class=" font-inter_regular mt-1 text-sm md:text-base xl:text-lg">If you have any questions about this Policy or other privacy concerns, you can also email us at webmaster@ynotzitsolutions.com</p>
