<div class=" lg:pb-12 z-30 overflow-hidden">
    ...
    <div class=" mt-7 mb-2.5 lg:mt-2.5 ">

        <h1 class=" uppercase font-inter_semibold text-lg sm:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-center ">OUR SERVICES</h1>

        <div class=" flex flex-col sm:flex-row flex-wrap items-center sm:items-start  justify-evenly 2xl:w-[84%] mx-auto lg:mt-5">
