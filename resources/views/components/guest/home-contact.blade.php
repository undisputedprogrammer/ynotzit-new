    ...
    <div class=" lg:flex justify-center order-1 sm:order-1 lg:w-[40%]">
        <div class=" lg:w-[55%]  lg:order-2 ">
            <div class=" relative mt-[7rem]  lg:mt-[7rem] transition  ">
                ...
                <img class="absolute w-36  sm:w-40 md:w-44 lg:w-48 xl:w-52 right-[calc(55%)] sm:right-[53%] md:right-[53%] lg:right-[72%] xl:right-[68%] 2xl:right-[68%] bottom-[75%]" src="{{asset('images/home/home-contact-dialog-1.png')}}" alt="Dudu speaking">

                <img class="absolute w-36  sm:w-40 md:w-44 lg:w-48 xl:w-52 left-[57%] sm:left-[55%] md:left-[55%] lg:left-[63%] xl:left-[60%] 2xl:left-[60%] bottom-[75%]" src="{{asset('images/home/home-contact-dialog-2.png')}}" alt="Dudu speaking">
