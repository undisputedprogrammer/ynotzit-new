<div x-data="{
    ...
    <div class="mx-auto w-4/5 sm:w-2/3 md:w-2/5 p-4 rounded-md shadow-md bg-base-100 border-base-300 text-center flex flex-col items-center space-y-4">
        <span x-text="message" class=" font-inter_regular"></span>
        <button class="btn btn-sm w-32 px-4 font-inter_regular" :class="mode == 'success' ? 'btn-success' : 'btn-error'" @click="doClose();">Ok</button>
    </div>
    <div></div>
</div>
